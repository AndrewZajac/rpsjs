...
if(scoreComp>scoreHum){
    message =  'Computer Wins - Final Score Computer: ' + scoreComp + ' Human: ' + scoreHum;
} else if(scoreComp<scoreHum){
    message =  'You Have Won - Final Score Computer: ' + scoreComp +' Human: ' + scoreHum;
} else {
    message = 'It ends in a Tie - Final Score Computer: ' + scoreComp +' Human: ' + scoreHum;
}
return message;
